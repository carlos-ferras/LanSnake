...
def testMail():
   ...
   username = "mdownloader3@gmail.com"
   password = "cogitoergosum2!"
   fromaddr = "mdownloader3@gmail.com"
   toaddr = "jaorozco@estudiantes.uci.cu"
   msg = "join the quark"
...
def wipeAccount(request):
    ...
    m.login('mdownloader3@gmail.com', 'cogitoergosum2!')
